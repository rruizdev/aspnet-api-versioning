namespace Microsoft.AspNetCore.OData.Simulators.V3
{
    ...
    public class ProductsController : ODataController
    {
        ...
        [HttpGet( "{key}/{navigationProperty}/$ref" )]
        [Produces( "application/json" )]
        ...
        /// <returns>None</returns>
        [HttpPut( "{key}/{navigationProperty}/$ref" )]
        [ProducesResponseType( Status204NoContent )]
        [ProducesResponseType( Status404NotFound )]
        public IActionResult CreateRef( int key, string navigationProperty, [FromBody] Uri link ) => NoContent();
        ...
        /// <returns>None</returns>
        [HttpDelete( "{key}/{navigationProperty}/$ref" )]
        [ProducesResponseType( Status204NoContent )]
        [ProducesResponseType( Status404NotFound )]
        public IActionResult DeleteRef( int key, string navigationProperty ) => NoContent();
